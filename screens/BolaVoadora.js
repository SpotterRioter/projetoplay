  ...
  return (
    <View style={styles.androidLarge2}>
      ...
      <Video
        ...
        source={require("../assets/Bola Voadora.mp4")} // Insira o caminho do vídeo aqui
      ...
      />
      <Text style={[styles.nHumano, styles.nHumanoClr]}>Bola Voadora</Text>
      <Text style={[styles.osParticipantesDevero, styles.descubraSeVocTypo]}>
       Um participante no centro comanda uma "bola voadora" suspensa em uma corda, enquanto objetos estão espalhados ao seu redor. Duas ou quatro equipes distante da região central tentam pegar objetos e levá-los de volta ao seu espaço sem serem tocadas pela bola voadora e marcar 1 ponto por objeto. Se a bola bater deve-se devolver o objeto e subtrai 1 ponto. A equipe com mais pontos vence.
      </Text>
      <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("FlyingBallQuiz1")}
      >
        <Image
