...
const MagicCubeQuiz1 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("MagicCubeQuiz2");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        Do que precisamos para brincar de cubo mágico?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 360}, {height: 300}]}>
        ...
        >
          <Text style={styles.answerText}>De 9 objetos com no mínimo 4 cores diferentes para formar um quadrado 3x3</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 420}]}>
        ...
        >
          <Text style={styles.answerText}>De 3 objetos de cores iguais</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout, {top: 480}, {height: 120}]}>
        ...
        >
          <Text style={styles.answerText}>De 10 objetos com cores iguais</Text>
        </Pressable>
      </View>
