...
const TrafficSignalQuiz2 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("TrafficSignalQuiz3");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        Quantos papéis cada participante tem que possuir na mão?
      </Text>
...
export default TrafficSignalQuiz2;
