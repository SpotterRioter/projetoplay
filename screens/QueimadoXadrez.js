  ...
  return (
    <View style={styles.androidLarge2}>
      ...
      <Video
        ...
        source={require("../assets/Queimado Xadrez.mp4")} // Insira o caminho do vídeo aqui
      ...
      />
      <Text style={[styles.nHumano, styles.nHumanoClr]}>Queimado Xadrez</Text>
      <Text style={[styles.osParticipantesDevero, styles.descubraSeVocTypo]}>
      Deve-se formar duas equipes com funções de peças de xadrez. As funções são: Rei, Rainha, Bispo, Peão, Cavalo e Torre, escolhendo apenas três para a partida. O Rei pode ser queimado para encerrar o jogo. Bispo substitui por alguém quando queimado, a Rainha tem três vidas, Peão não morre, a Torre joga com a mão oposta, e o Cavalo pode indicar um peão após ser queimado, mas apenas uma vez. O jogo termina quando o Rei é queimado. Obs: a equipe adversária não pode saber quais peças representam a outra equipe. E toda partida é obrigatório ter um rei.
      </Text>
      <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("ChessBurnQuiz1")}
      >
        <Image
