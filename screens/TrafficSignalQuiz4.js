...
const TrafficSignalQuiz4 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("TrafficSignalQuiz5");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      O que os jogadores devem fazer quando o orientador levantar os papéis?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 350}, {height: 300}]}>
        ...
        >
          <Text style={styles.answerText}>Deve abaixar o seu papel também e ficar parado</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 420}, {height: 60}]}>
        ...
        >
          <Text style={styles.answerText}>Deve correr</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout, {top: 490}, {height: 140}]}>
        ...
        >
          <Text style={styles.answerText}>Deve levantar o seu papel e sair do jogo</Text>
        </Pressable>
      </View>
...
export default TrafficSignalQuiz4;