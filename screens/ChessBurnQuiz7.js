...
const ChessBurnQuiz7 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("ChessBurnQuiz8");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        O que o jogador que for a torre deve fazer?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 330}]}>
        ...
        >
          <Text style={styles.answerText}>Deve chutar a bola</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 390}]}>
        ...
        >
          <Text style={styles.answerText}>Deve jogar a bola com a mão que não escreve</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout,{top: 460}]}>
        <View style={[styles.groupChild, styles.groupChildPosition]} />
        <Pressable
        ...
        >
          <Text style={styles.answerText}>Deve jogar sentado</Text>
        </Pressable>
      </View>
      <Pressable
