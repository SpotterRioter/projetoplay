  ...
  return (
    <View style={styles.quiz}>
      ...
      <View style={[styles.rectangleParent, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Resolver mais rápido</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout, {top: 440}, {height: 300}]}>
        ...
        >
          <Text style={styles.answerText}>Resolver no maior tempo</Text>
        </Pressable>
      </View>
      <Pressable
