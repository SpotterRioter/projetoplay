...
const ConeHitQuiz4 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("ConeHitQuiz5");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        Quantos pontos vale cada acerto no cone?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>1 ponto</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>2 pontos</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>5 pontos</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>10 pontos</Text>
        </Pressable>
      </View>
      <Pressable
