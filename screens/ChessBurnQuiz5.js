  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        Qual o super poder do peão durante o jogo?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Ele tem o super pulo</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout, {top: 440}, {height: 300}]}>
        ...
        >
          <Text style={styles.answerText}>Ele é imortal e defende a equipe</Text>
        </Pressable>
      </View>
      <Pressable
