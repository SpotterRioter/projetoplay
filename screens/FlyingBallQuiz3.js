...
const FlyingBallQuiz3 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("FlyingBallQuiz4");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <View style={[styles.rectangleContainer, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>2 ou 4</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>11</Text>
        </Pressable>
      </View>
      <Pressable
...
export default FlyingBallQuiz3;
