...
const  MagicCubeQuiz2 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("MagicCubeQuiz3");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        Como joga o jogo do cubo mágico?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Cada jogador deve bagunçar as cores</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout, {top: 440}, {height: 300}]}>
        <View style={[styles.groupChild, styles.groupChildPosition, {height: 80}]} />
        <Pressable
        ...
        >
          <Text style={styles.answerText}>Um jogador por vez deve trocar as cores de lugar até organizar o cubo igual na figura</Text>
        </Pressable>
      </View>
      <Pressable
