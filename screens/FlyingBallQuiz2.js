...
const  FlyingBallQuiz2 = () => {
  ...
  return (
    <View style={styles.quiz}>
      ...
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 350}]}>
        ...
        >
          <Text style={styles.answerText}>Se esquivar da bola voadora maluca e tocar no professor</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout, {top: 420}, {height: 300}]}>
        ...
        >
          <Text style={styles.answerText}>Pegar os objetos no chão sem ser pego pela bola voadora;</Text>
        </Pressable>
      </View>
      <Pressable
...
export default FlyingBallQuiz2;
