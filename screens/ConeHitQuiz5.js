  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        Para deixar a brincadeira mais difícil, o que podemos fazer?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Adicionar duas bolas</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout, {top: 440}]}>
        ...
        >
          <Text style={styles.answerText}>Tirar um cone</Text>
        </Pressable>
      </View>
      <Pressable
