...
const ConeHitQuiz3 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("ConeHitQuiz4");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      Quantos cones devemos colocar na terceira rodada da brincadeira?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 360}]}>
        ...
        >
          <Text style={styles.answerText}>1 cone</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 420}]}>
        ...
        >
          <Text style={styles.answerText}>2 cones</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout, {top: 480}, {height: 120}]}>
        ...
        >
          <Text style={styles.answerText}>3 cones</Text>
        </Pressable>
      </View>
