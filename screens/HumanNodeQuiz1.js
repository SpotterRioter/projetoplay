...
const HumanNodeQuiz1 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("HumanNodeQuiz2");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        No "nó humano" nível fácil, os participantes devem:
      </Text>
      ...
      <View style={[styles.groupView, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Soltar as mãos</Text>
        </Pressable>
      </View>
      <Pressable
