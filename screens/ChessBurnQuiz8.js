  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        O que acontece se o bispo for queimado?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 330}]}>
        ...
        >
          <Text style={styles.answerText}>Ele pode mandar alguém no seu lugar para área do morto</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 390}]}>
        ...
        >
          <Text style={styles.answerText}>Ele fica invisível</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout,{top: 460}]}>
        ...
        >
          <Text style={styles.answerText}>A partida acaba</Text>
        </Pressable>
      </View>
      <Pressable
