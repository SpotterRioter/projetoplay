...
const ChessBurnQuiz6 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("ChessBurnQuiz7");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.quizNHumano}>Quiz Queimado Xadrez</Text>
      <Text style={styles.text}>
        <Text style={styles.text1}>6</Text>
        <Text style={styles.text2}>/8</Text>
      </Text>
      <Text style={styles.noNHumano}>
        Se o cavalo for queimado, quantas vezes ele pode mandar o peão para área do morto no seu lugar?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 330}]}>
        ...
        >
          <Text style={styles.answerText}>Todas as vezes</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 390}]}>
        <View style={[styles.groupChild, styles.groupChildPosition]} />
        <Pressable
        ...
        >
          <Text style={styles.answerText}>Uma vez</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout,{top: 450}]}>
        <View style={[styles.groupChild, styles.groupChildPosition]} />
        <Pressable
        ...
        >
          <Text style={styles.answerText}>Três vezes</Text>
        </Pressable>
      </View>
      <Pressable
