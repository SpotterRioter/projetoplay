...
const HumanNodeQuiz4 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("HumanNodeQuiz5");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        No nível difícil, qual material é utilizado para tapar os olhos?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 360}]}>
        ...
        >
          <Text style={styles.answerText}>Dar as mãos e virar de costas</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 420}]}>
        ...
        >
          <Text style={styles.answerText}>Memorizar quem está ao seu lado</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout, {top: 480}]}>
        <View style={[styles.groupChild, styles.groupChildPosition]} />
        <Pressable
        ...
        >
          <Text style={styles.answerText}>Se entrelaçar com os braços cruzados</Text>
        </Pressable>
      </View>
