...
const FlyingBallQuiz1 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("FlyingBallQuiz2");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.quizNHumano}>Quiz Bola Voadora</Text>
      <Text style={styles.text}>
        <Text style={styles.text1}>1</Text>
        <Text style={styles.text2}>/5</Text>
      </Text>
      <Text style={styles.noNHumano}>
      Onde fica o comandante que gira a bola do jogo?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 350}, {height: 300}]}>
        ...
        >
          <Text style={styles.answerText}>Na esquerda</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 420}, {height: 60}]}>
        ...
        >
          <Text style={styles.answerText}>Na direita</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout, {top: 490}, {height: 140}]}>
        ...
        >
          <Text style={styles.answerText}>No centro</Text>
        </Pressable>
      </View>
...
export default FlyingBallQuiz1;