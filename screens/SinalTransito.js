  ...
  return (
    <View style={styles.androidLarge2}>
      ...
      <Video
        ...
        source={require("../assets/Sinal de Trânsito.mp4")} // Insira o caminho do vídeo aqui
      ...
      />
      <Text style={[styles.nHumano, styles.nHumanoClr]}>Sinal de Trânsito</Text>
      <Text style={[styles.osParticipantesDevero, styles.descubraSeVocTypo]}>
      Duas linhas são desenhadas no chão, uma de partida e outra de chegada, com pelo menos 5 metros de distância. Os participantes e o orientador seguram papéis verdes, amarelos e vermelhos. Ao sinal do orientador, correspondendo à cor do papel levantado, eles avançam rápido no verde, avançam devagar no amarelo ou ficam parados vermelho. Quem chegar primeiro à linha de chegada corretamente vence; se errar deve retornar à linha de partida. Variações incluem pular com um pé só ou se mover de cócoras nas próximas rodadas.
      </Text>
      <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("TrafficSignalQuiz1")}
      >
        <Image
