...
const ChessBurnQuiz2 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("ChessBurnQuiz3");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      Qual peça é obrigatória ter nas duas equipes sempre?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Bispo</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Rei</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Cavalo</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Rainha</Text>
        </Pressable>
      </View>
      <Pressable
