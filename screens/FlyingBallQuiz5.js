  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        O que acontece se a bola bater em um dos jogadores com um objeto na mão?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Perde 1 ponto e deve devolver o objeto</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Não acontece nada e o jogo continua</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Perde 5 pontos</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Deve devolver todos os objetos</Text>
        </Pressable>
      </View>
      <Pressable
...
export default FlyingBallQuiz5;
