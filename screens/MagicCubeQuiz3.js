...
const MagicCubeQuiz3 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("MagicCubeQuiz4");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        Quantas movimentações cada jogador deve fazer?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Apenas uma</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Duas vezes</Text>
        </Pressable>
      </View>
      ...
      <View style={[styles.groupView, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Cinco vezes</Text>
        </Pressable>
      </View>
      <Pressable
