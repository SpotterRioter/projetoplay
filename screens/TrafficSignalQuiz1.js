...
const TrafficSignalQuiz1 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("TrafficSignalQuiz2");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      Para essa brincadeira qual distância você marca  da linha de partida para a de chegada?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>3 metros</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>1 metro</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Cinco metros</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Dois metros</Text>
        </Pressable>
      </View>
      <Pressable
...
export default TrafficSignalQuiz1;
