...
const TrafficSignalQuiz5 = () => {
  ...
  return (
    <View style={styles.quiz}>
      ...
      O que acontece quando uma pessoa faz um comando de forma incorreta?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 350}, {height: 300}]}>
        ...
        >
          <Text style={styles.answerText}>Permanece no local e só participa na próxima rodada</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 420}, {height: 60}]}>
        ...
        >
          <Text style={styles.answerText}>Voltar para a linha inicial do jogo</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout, {top: 490}, {height: 140}]}>
        ...
        >
          <Text style={styles.answerText}>Perde um ponto a cada erro cometido no jogo</Text>
        </Pressable>
      </View>
...
export default TrafficSignalQuiz5;