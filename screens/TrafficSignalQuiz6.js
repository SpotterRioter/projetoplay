...
const TrafficSignalQuiz6 = () => {
  ...
  return (
    <View style={styles.quiz}>
      ...
      No nível difícil do sinal de trânsito o que deve ser feito?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 350}, {height: 300}]}>
        ...
        >
          <Text style={styles.answerText}>Ir pulando de um pé só ou de cócoras</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 420}, {height: 60}]}>
        ...
        >
          <Text style={styles.answerText}>Ir rolando</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout, {top: 490}, {height: 140}]}>
        ...
        >
          <Text style={styles.answerText}>Ir de olhos fechados</Text>
        </Pressable>
      </View>
...
export default TrafficSignalQuiz6;