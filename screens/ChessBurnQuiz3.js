...
const ChessBurnQuiz4 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("ChessBurnQuiz5");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        Qual o poder da rainha durante o jogo?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 360}, {height: 320}]}>
        ...
        >
          <Text style={styles.answerText}>Ela é imortal</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 420}]}>
        ...
        >
          <Text style={styles.answerText}>Ela tem 3 vidas</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout, {top: 480}, {height: 120}]}>
        ...
        >
          <Text style={styles.answerText}>Ela tem a super velocidade</Text>
        </Pressable>
      </View>
