...
const HumanNodeQuiz2 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("HumanNodeQuiz4");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.noNHumano}>
        O que não se pode fazer no nó humano?
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout]}>
        ...
        >
          <Text style={styles.answerText}>Desfazer o nó</Text>
        </Pressable>
      </View>
      <View style={[styles.groupView, styles.groupLayout, {top: 440}]}>
        <View style={[styles.groupChild, styles.groupChildPosition]} />
        <Pressable
        ...
        >
          <Text style={styles.answerText}>Soltar as mãos antes de desfazer o nó</Text>
        </Pressable>
      </View>
      <Pressable
