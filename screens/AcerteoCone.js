  ...
  return (
    <View style={styles.androidLarge2}>
      ...
      <Video
        ...
        source={require("../assets/Acerte o Cone.mp4")} // Insira o caminho do vídeo aqui
      ...
      />
      <Text style={[styles.nHumano, styles.nHumanoClr]}>Acerte o Cone</Text>
      <Text style={[styles.osParticipantesDevero, styles.descubraSeVocTypo]}>
      Duas equipes ocuparão espaços distintos (lado A e lado B) em uma atividade com três rodadas. Na primeira, cada equipe tem um cone. O objetivo é derrubar o cone adversário, marcando 1 ponto por queda. A segunda rodada inicia com dois cones por equipe, encerrando com 2 pontos da equipe vencedora. Na última rodada, cada equipe tem três cones, buscando marcar 3 pontos ao derrubar os cones adversários. Vence a equipe com mais pontos após as três rodadas.
      </Text>
      <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("ConeHitQuiz1")}
      >
        <Image
