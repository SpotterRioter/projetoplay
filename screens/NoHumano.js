  ...
  return (
    <View style={styles.androidLarge2}>
      ...
      <Video
        ...
        source={require("../assets/Nó Humano.mp4")} // Insira o caminho do vídeo aqui
      ...
      />
      <Text style={[styles.nHumano, styles.nHumanoClr]}>Nó Humano</Text>
      <Text style={[styles.osParticipantesDevero, styles.descubraSeVocTypo]}>
        Os participantes deverão, de mãos dadas, formar um círculo. Eles deverão
        memorizar quem está ao seu lado direito e lado esquerdo. Em seguida,
        devem andar, “misturando-se” e no comando do orientador deverão parar,
        os participantes deverão localizar quem estava aos seus lados e darão a
        mão direita a mão esquerda daquele que estava à sua direita no início, e
        a mão esquerda deverá ser dada a mão direita de quem estava à sua
        esquerda. Os participantes ficarão entrelaçados e terão por objetivo
        desfazê-lo sem soltar as mãos.
      </Text>
      <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("HumanNodeQuiz1")}
      >
        <Image
