...
const TrafficSignalQuiz3 = () => {
  ...
  const handleNextButton = () => {
    ...
    navigation.navigate("TrafficSignalQuiz4");
  };
  ...
  return (
    <View style={styles.quiz}>
      ...
      <Text style={styles.quizNHumano}>Quiz Sinal de Trânsito</Text>
      <Text style={styles.text}>
        <Text style={styles.text1}>3</Text>
        <Text style={styles.text2}>/6</Text>
      </Text>
      <Text style={styles.noNHumano}>
      Indique as ações corretas de cada cor do jogo
      </Text>
      <View style={[styles.rectangleParent, styles.groupLayout, {top: 350}, {height: 300}]}>
        ...
        >
          <Text style={styles.answerText}>Vermelho (para de andar) - Amarelo (devagar) - Verde (anda rapidamente).</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleGroup, styles.groupLayout, {top: 420}, {height: 60}]}>
        <View style={[styles.groupChild, styles.groupChildPosition, {height: 60}]} />
        <Pressable
        ...
        >
          <Text style={styles.answerText}>Vermelho (devagar) - Amarelo (para de andar) - Verde (anda rapidamente).</Text>
        </Pressable>
      </View>
      <View style={[styles.rectangleContainer, styles.groupLayout, {top: 490}, {height: 140}]}>
        <View style={[styles.groupChild, styles.groupChildPosition, {height: 60}]} />
        <Pressable
        ...
        >
          <Text style={styles.answerText}>Vermelho (anda rapidamente) - Amarelo (anda devagar) - Verde (para de andar)</Text>
        </Pressable>
      </View>
...
export default TrafficSignalQuiz3;